...
export class Universe {
    ...
    * @param {WebGLUniformLocation} trans_location
    * @param {WebGLUniformLocation} time_location
    * @param {number} t
    */
    constructor(gl, trans_location, time_location, t) {
        var ret = wasm.universe_new(addHeapObject(gl), addHeapObject(trans_location), addHeapObject(time_location), t);
    ...
    * @param {boolean} shift
    */
    update(t, left, right, down, up, space, shift) {
        wasm.universe_update(this.ptr, t, left, right, down, up, space, shift);
    }
    /**
    * @param {number} t
    */
    render(t) {
        wasm.universe_render(this.ptr, t);
    }
}
